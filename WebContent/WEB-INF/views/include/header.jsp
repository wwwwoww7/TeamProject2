...
<header class="header dark-bg">
	<div class="toggle-nav">
		<div class="icon-reorder tooltips"
			...
			<span style="color: black;">메뉴토글</span> <i class="icon_menu"></i>
		</div>
	</div>
	<!--logo start-->
	<a href="index.html" class="logo">To More <span class="lite">Learn</span></a>
	<!--logo end-->
		...
		<ul class="nav pull-right top-menu">
			...
			<li id="task_notificatoin_bar" class="dropdown"><a
				data-toggle="dropdown" class="dropdown-toggle" href="#"> <i
					class="">장바구니</i> <span class="badge bg-important">6</span>
			</a></li>
