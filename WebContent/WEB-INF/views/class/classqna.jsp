					...
					<div class="row">
						<div class="col-lg-12">
							...
							<ol class="breadcrumb">
								...
								<li><i class="fa fa-lg"></i>Class 문의</li>
							</ol>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-lg-12">
							<section class="panel">
								<header class="panel-heading"> 문의 내용 </header>
								
								<div class="panel-body">
									<form class="form-horizontal" method="post" action="writeQA">
										<!--date picker start-->
	
										<div class="form-group">
											<label class="control-label col-sm-4">문의 제목</label>
											<div class="col-sm-6">
												<input id="dp1" type="text" value="제목" size="16" class="form-control"/>
											</div>
										</div>
										
										<div class="form-group">
											<label class="control-label col-sm-4">문의 내용</label>
											<div class="col-sm-6">
												<div id="editor" class="btn-toolbar" data-role="editor-toolbar" data-target="#editor"></div>
											</div>
										</div>
										
										<button type="submit" class="btn btn-dark">문의 작성</button>
									</form>
								</div>
